...
PATH_TO_CKPT = '/SDD4.0/server/api/hand_inference_graph/frozen_inference_graph_2.pb'
# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = '/SDD4.0/server/api/hand_inference_graph/hand_label_map.pbtxt'
